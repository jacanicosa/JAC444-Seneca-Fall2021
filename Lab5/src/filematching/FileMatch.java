...
public class FileMatch {
	...
	public void openFiles() {
		try {
			inOldMaster = new Scanner( new File( "C:\\Users\\Albert\\eclipse-workspace\\Lab5\\src\\filematchtxt\\oldmast.txt" ) );
			inTransaction = new Scanner( new File( "C:\\Users\\Albert\\eclipse-workspace\\Lab5\\src\\filematchtxt\\trans.txt" ) );
			outNewMaster = new Formatter( new File( "C:\\Users\\Albert\\eclipse-workspace\\Lab5\\src\\filematchtxt\\newmast.txt" ) );
			logFile = new Formatter( "C:\\Users\\Albert\\eclipse-workspace\\Lab5\\src\\filematchtxt\\log.txt" );
		}
