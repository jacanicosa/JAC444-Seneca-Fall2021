...
public class CreateData {
	...
	public static void main(String[] args) {
		...
		try {
			outOldMaster = new Formatter(new File ( "C:\\Users\\Albert\\eclipse-workspace\\Lab5\\src\\fmtxt2\\oldmast.txt" ));
			...
			outTransaction = new Formatter( new File ( "C:\\Users\\Albert\\eclipse-workspace\\Lab5\\src\\fmtxt2\\trans.txt" ) );
